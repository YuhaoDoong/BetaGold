...
**首次训练结果** (OOS, 2025-10 ~ 2026-03):

| 指标 | 7h (日内) | 35h (5天) |
|------|---------|---------|
| Coverage | 65.6% | 63.2% |
| IC upper | 0.042 | -0.196 |
| IC lower | 0.163 | 0.255 |
| 区间宽度 | 5.36% | 11.43% |

**状态**: 基线完成，Coverage 和 IC 待优化。下一步:
- [ ] 调参: seq_len, hidden_size, quantile thresholds
- [ ] 特征筛选: 去除噪声特征, 增加交叉特征
- [ ] 信号系统: 基于 1h Band Position 的盘中信号
- [ ] Dashboard 集成: 1h 模型接入 app.py
- [ ] 回测: 盘中信号 vs v1.0 收盘信号对比
